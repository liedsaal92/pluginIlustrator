...
export const CSV_COLUMN_ORDER: string[] = [
  ...
  // PANT IZQ — LÍNEAS
  'LLEVA_PANT_IZQ_LINEA_IZQ', 'PANT_IZQ_LINEA_IZQ_ANCHO', 'PANT_IZQ_LINEA_IZQ_ALTO', 'PANT_IZQ_LINEA_IZQ_REF',
  'LLEVA_PANT_IZQ_LINEA_DER', 'PANT_IZQ_LINEA_DER_ANCHO', 'PANT_IZQ_LINEA_DER_ALTO', 'PANT_IZQ_LINEA_DER_REF',
  'LLEVA_PANT_IZQ_LINEA_INF', 'PANT_IZQ_LINEA_INF_ANCHO', 'PANT_IZQ_LINEA_INF_ALTO', 'PANT_IZQ_LINEA_INF_REF',
  // PANT IZQ — LINEAS ADIDAS
  'LLEVA_LINEAS_ADIDAS_P_IZQ', 'LINEAS_ADIDAS_P_IZQ_ANCHO', 'LINEAS_ADIDAS_P_IZQ_REF', 'LINEAS_ADIDAS_P_IZQ_MARGIN_INF',
  // PANT DER — LÍNEAS
  'LLEVA_PANT_DER_LINEA_IZQ', 'PANT_DER_LINEA_IZQ_ANCHO', 'PANT_DER_LINEA_IZQ_ALTO', 'PANT_DER_LINEA_IZQ_REF',
  'LLEVA_PANT_DER_LINEA_DER', 'PANT_DER_LINEA_DER_ANCHO', 'PANT_DER_LINEA_DER_ALTO', 'PANT_DER_LINEA_DER_REF',
  'LLEVA_PANT_DER_LINEA_INF', 'PANT_DER_LINEA_INF_ANCHO', 'PANT_DER_LINEA_INF_ALTO', 'PANT_DER_LINEA_INF_REF',
  // PANT DER — LINEAS ADIDAS
  'LLEVA_LINEAS_ADIDAS_P_DER', 'LINEAS_ADIDAS_P_DER_ANCHO', 'LINEAS_ADIDAS_P_DER_REF', 'LINEAS_ADIDAS_P_DER_MARGIN_INF',
];
...
// ── Metadata de grupos ────────────────────────────────────────
export const ELEMENT_GROUPS: Record<string, { label: string; icon: string }> = {
  identificacion: { label: 'IDENTIFICACIÓN', icon: '✦' },
  logos:          { label: 'LOGOS & ESCUDOS', icon: '⬡' },
  sponsors:       { label: 'SPONSORS',        icon: '★' },
  etiquetas:      { label: 'ETIQUETAS',       icon: '⬚' },
  decoracion:     { label: 'DECORACIÓN',      icon: '|||' },
  lineas:         { label: 'LÍNEAS',          icon: '|' },
};
...
export const SCHEMA: Schema = {
  frente: {
    ...
    color: '#E8462A',
    elements: [
      { id: 'nombre_f', label: 'NOMBRE', icon: '✦', group: 'identificacion', toggleKey: 'LLEVA_NOMBRE_F',
      ...
      { id: 'numero_f', label: 'NÚMERO', icon: '#', group: 'identificacion', toggleKey: 'LLEVA_NUMERO_F',
      ...
      { id: 'escudo_f', label: 'ESCUDO', icon: '⬡', group: 'logos', toggleKey: 'LLEVA_ESCUDO_F',
      ...
      { id: 'escudo_central', label: 'ESCUDO CENTRAL', icon: '⬡', group: 'logos', toggleKey: 'LLEVA_ESCUDO_CENTRAL',
      ...
      { id: 'logo_marca', label: 'LOGO MARCA', icon: '◈', group: 'logos', toggleKey: 'LLEVA_LOGO_MARCA',
      ...
      { id: 'sponsor_top_izq', label: 'SPONSOR TOP IZQ', icon: '◧', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_TOP_IZQ',
      ...
      { id: 'sponsor_top_der', label: 'SPONSOR TOP DER', icon: '◨', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_TOP_DER',
      ...
      { id: 'sponsor_top_izq_sec', label: 'SPONSOR TOP IZQ SEC', icon: '◧', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_TOP_IZQ_SEC',
      ...
      { id: 'sponsor_top_der_sec', label: 'SPONSOR TOP DER SEC', icon: '◨', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_TOP_DER_SEC',
      ...
      { id: 'sponsor_principal_f', label: 'SPONSOR PRINCIPAL', icon: '★', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_PRINCIPAL_F',
      ...
      { id: 'sponsor_secundario_f', label: 'SPONSOR SECUNDARIO', icon: '☆', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_SECUNDARIO_F',
      ...
      { id: 'costilla_f', label: 'COSTILLA', icon: '|||', group: 'decoracion', toggleKey: 'LLEVA_COSTILLA_F',
        fields: [numField('COSTILLA_F_ANCHO', 'Ancho'), numField('COSTILLA_F_ALTO', 'Alto'), refField('COSTILLA_F_REF')] },
      { id: 'etiqueta_principal_f', label: 'ETIQUETA PRINCIPAL', icon: '⬚', group: 'etiquetas', toggleKey: 'LLEVA_ETIQUETA_PRINCIPAL_F',
        fields: [
      ...
      { id: 'etiqueta_secundaria_f', label: 'ETIQUETA SECUNDARIA', icon: '⬙', group: 'etiquetas', toggleKey: 'LLEVA_ETIQUETA_SECUNDARIA_F',
        fields: [
  ...
  espalda: {
    ...
    color: '#F5C842',
    elements: [
      { id: 'nombre_e', label: 'NOMBRE', icon: '✦', group: 'identificacion', toggleKey: 'LLEVA_NOMBRE_E',
      ...
      { id: 'numero_e', label: 'NÚMERO', icon: '#', group: 'identificacion', toggleKey: 'LLEVA_NUMERO_E',
      ...
      { id: 'etiqueta_top', label: 'ETIQUETA TOP', icon: '⬒', group: 'etiquetas', toggleKey: 'LLEVA_ETIQUETA_TOP',
        fields: [
      ...
      { id: 'etiqueta_principal_e', label: 'ETIQUETA PRINCIPAL', icon: '⬚', group: 'etiquetas', toggleKey: 'LLEVA_ETIQUETA_PRINCIPAL_E',
        fields: [
      ...
      { id: 'etiqueta_secundaria_e', label: 'ETIQUETA SECUNDARIA', icon: '⬙', group: 'etiquetas', toggleKey: 'LLEVA_ETIQUETA_SECUNDARIA_E',
        fields: [
      ...
      { id: 'sponsor_principal_e', label: 'SPONSOR PRINCIPAL', icon: '★', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_PRINCIPAL_E',
      ...
      { id: 'sponsor_secundario_e', label: 'SPONSOR SECUNDARIO', icon: '☆', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_SECUNDARIO_E',
      ...
      { id: 'costilla_e', label: 'COSTILLA', icon: '|||', group: 'decoracion', toggleKey: 'LLEVA_COSTILLA_E',
  ...
  manga_izq: {
    ...
    color: '#4A9BE8',
    elements: [
      { id: 'numero_m_izq', label: 'NÚMERO', icon: '#', group: 'identificacion', toggleKey: 'LLEVA_NUMERO_M_IZQ',
      ...
      { id: 'escudo_m_izq', label: 'ESCUDO', icon: '⬡', group: 'logos', toggleKey: 'LLEVA_ESCUDO_M_IZQ',
      ...
      { id: 'sponsor_secundario_m_izq', label: 'SPONSOR SECUNDARIO', icon: '☆', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_SECUNDARIO_M_IZQ',
      ...
      { id: 'linea_izq_izq', label: 'LÍNEA LATERAL IZQ', icon: '|', group: 'lineas', toggleKey: 'LLEVA_MANGA_IZQ_LINEA_IZQ',
        fields: [numField('MANGA_IZQ_LINEA_IZQ_ANCHO', 'Ancho'), numField('MANGA_IZQ_LINEA_IZQ_ALTO', 'Alto'), refField('MANGA_IZQ_LINEA_IZQ_REF')] },
      { id: 'linea_izq_der', label: 'LÍNEA LATERAL DER', icon: '|', group: 'lineas', toggleKey: 'LLEVA_MANGA_IZQ_LINEA_DER',
        fields: [numField('MANGA_IZQ_LINEA_DER_ANCHO', 'Ancho'), numField('MANGA_IZQ_LINEA_DER_ALTO', 'Alto'), refField('MANGA_IZQ_LINEA_DER_REF')] },
      { id: 'linea_izq_inf', label: 'LÍNEA INFERIOR', icon: '—', group: 'lineas', toggleKey: 'LLEVA_MANGA_IZQ_LINEA_INF',
        fields: [numField('MANGA_IZQ_LINEA_INF_ANCHO', 'Ancho'), numField('MANGA_IZQ_LINEA_INF_ALTO', 'Alto'), refField('MANGA_IZQ_LINEA_INF_REF')] },
      { id: 'lineas_adidas_izq', label: 'LINEAS ADIDAS', icon: '≡', group: 'lineas', toggleKey: 'LLEVA_LINEAS_ADIDAS_M_IZQ',
        fields: [
  ...
  manga_der: {
    ...
    color: '#7B5CF0',
    elements: [
      { id: 'numero_m_der', label: 'NÚMERO', icon: '#', group: 'identificacion', toggleKey: 'LLEVA_NUMERO_M_DER',
      ...
      { id: 'escudo_m_der', label: 'ESCUDO', icon: '⬡', group: 'logos', toggleKey: 'LLEVA_ESCUDO_M_DER',
      ...
      { id: 'sponsor_secundario_m_der', label: 'SPONSOR SECUNDARIO', icon: '☆', group: 'sponsors', toggleKey: 'LLEVA_SPONSOR_SECUNDARIO_M_DER',
      ...
      { id: 'linea_der_izq', label: 'LÍNEA LATERAL IZQ', icon: '|', group: 'lineas', toggleKey: 'LLEVA_MANGA_DER_LINEA_IZQ',
        fields: [numField('MANGA_DER_LINEA_IZQ_ANCHO', 'Ancho'), numField('MANGA_DER_LINEA_IZQ_ALTO', 'Alto'), refField('MANGA_DER_LINEA_IZQ_REF')] },
      { id: 'linea_der_der', label: 'LÍNEA LATERAL DER', icon: '|', group: 'lineas', toggleKey: 'LLEVA_MANGA_DER_LINEA_DER',
        fields: [numField('MANGA_DER_LINEA_DER_ANCHO', 'Ancho'), numField('MANGA_DER_LINEA_DER_ALTO', 'Alto'), refField('MANGA_DER_LINEA_DER_REF')] },
      { id: 'linea_der_inf', label: 'LÍNEA INFERIOR', icon: '—', group: 'lineas', toggleKey: 'LLEVA_MANGA_DER_LINEA_INF',
        fields: [numField('MANGA_DER_LINEA_INF_ANCHO', 'Ancho'), numField('MANGA_DER_LINEA_INF_ALTO', 'Alto'), refField('MANGA_DER_LINEA_INF_REF')] },
      { id: 'lineas_adidas_der', label: 'LINEAS ADIDAS', icon: '≡', group: 'lineas', toggleKey: 'LLEVA_LINEAS_ADIDAS_M_DER',
        fields: [
  ...
  pant_izq: {
    ...
    elements: [
      ...
      { id: 'linea_p_izq_lat_izq', label: 'LÍNEA LATERAL IZQ', icon: '|', group: 'lineas', toggleKey: 'LLEVA_PANT_IZQ_LINEA_IZQ',
        fields: [numField('PANT_IZQ_LINEA_IZQ_ANCHO', 'Ancho'), numField('PANT_IZQ_LINEA_IZQ_ALTO', 'Alto'), refField('PANT_IZQ_LINEA_IZQ_REF')] },
      { id: 'linea_p_izq_lat_der', label: 'LÍNEA LATERAL DER', icon: '|', group: 'lineas', toggleKey: 'LLEVA_PANT_IZQ_LINEA_DER',
        fields: [numField('PANT_IZQ_LINEA_DER_ANCHO', 'Ancho'), numField('PANT_IZQ_LINEA_DER_ALTO', 'Alto'), refField('PANT_IZQ_LINEA_DER_REF')] },
      { id: 'linea_p_izq_inf', label: 'LÍNEA INFERIOR', icon: '—', group: 'lineas', toggleKey: 'LLEVA_PANT_IZQ_LINEA_INF',
        fields: [numField('PANT_IZQ_LINEA_INF_ANCHO', 'Ancho'), numField('PANT_IZQ_LINEA_INF_ALTO', 'Alto'), refField('PANT_IZQ_LINEA_INF_REF')] },
      { id: 'lineas_adidas_p_izq', label: 'LINEAS ADIDAS', icon: '≡', group: 'lineas', toggleKey: 'LLEVA_LINEAS_ADIDAS_P_IZQ',
        fields: [numField('LINEAS_ADIDAS_P_IZQ_ANCHO', 'Ancho'), refField('LINEAS_ADIDAS_P_IZQ_REF'), numField('LINEAS_ADIDAS_P_IZQ_MARGIN_INF', 'Margen inf')] },
    ],
  },
  ...
  pant_der: {
    ...
    elements: [
      ...
      { id: 'linea_p_der_lat_izq', label: 'LÍNEA LATERAL IZQ', icon: '|', group: 'lineas', toggleKey: 'LLEVA_PANT_DER_LINEA_IZQ',
        fields: [numField('PANT_DER_LINEA_IZQ_ANCHO', 'Ancho'), numField('PANT_DER_LINEA_IZQ_ALTO', 'Alto'), refField('PANT_DER_LINEA_IZQ_REF')] },
      { id: 'linea_p_der_lat_der', label: 'LÍNEA LATERAL DER', icon: '|', group: 'lineas', toggleKey: 'LLEVA_PANT_DER_LINEA_DER',
        fields: [numField('PANT_DER_LINEA_DER_ANCHO', 'Ancho'), numField('PANT_DER_LINEA_DER_ALTO', 'Alto'), refField('PANT_DER_LINEA_DER_REF')] },
      { id: 'linea_p_der_inf', label: 'LÍNEA INFERIOR', icon: '—', group: 'lineas', toggleKey: 'LLEVA_PANT_DER_LINEA_INF',
        fields: [numField('PANT_DER_LINEA_INF_ANCHO', 'Ancho'), numField('PANT_DER_LINEA_INF_ALTO', 'Alto'), refField('PANT_DER_LINEA_INF_REF')] },
      { id: 'lineas_adidas_p_der', label: 'LINEAS ADIDAS', icon: '≡', group: 'lineas', toggleKey: 'LLEVA_LINEAS_ADIDAS_P_DER',
        fields: [numField('LINEAS_ADIDAS_P_DER_ANCHO', 'Ancho'), refField('LINEAS_ADIDAS_P_DER_REF'), numField('LINEAS_ADIDAS_P_DER_MARGIN_INF', 'Margen inf')] },
    ],
  },
};
